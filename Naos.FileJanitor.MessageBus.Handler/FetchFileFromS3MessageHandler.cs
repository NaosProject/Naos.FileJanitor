...
namespace Naos.FileJanitor.MessageBus.Handler
{
    ...
    {
        /// <inheritdoc />
        public async Task Handle(FetchFileFromS3Message message)
        {
        ...
        public async Task Handle(FetchFileFromS3Message message, FileJanitorMessageHandlerSettings settings)
        {
